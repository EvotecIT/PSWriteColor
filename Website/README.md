# PSWriteColor Website Content

This folder contains curated source content that the Evotec website imports for the PSWriteColor project page.

## Layout

- `content/project-docs/` contains short project documentation pages shown under /projects/pswritecolor/docs/.
- `content/examples/` contains curated website examples shown under /projects/pswritecolor/examples/.
...
- Keep links rooted at /projects/pswritecolor/ so the same content works on localhost, evotec.xyz, and evotec.pl.
